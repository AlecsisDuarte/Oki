...
import com.itm.oki.oki.camera.BackgroundSoundService;
import com.itm.oki.oki.camera.GraphicOverlay;
...
class GooglyFaceTracker extends Tracker<Face> {
    ...
    public boolean mPreviousIsLeftOpen = true;
    public boolean mPreviousIsRightOpen = true;
    ...
    public void onUpdate(FaceDetector.Detections<Face> detectionResults, Face face) {
        ...
        try{
            ...
            if(!isLeftOpen && !isRightOpen){
                Intent svc=new Intent(ctext, BackgroundSoundService.class);
                ctext.startService(svc);
            }
            else
            if(isLeftOpen || isRightOpen  ){
                ctext.stopService(new Intent(ctext,BackgroundSoundService.class));
                }
